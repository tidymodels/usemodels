...
---
    ...
    Output
      ...
      [17] "  step_normalize(all_numeric_predictors()) "                                                
      [18] ""                                                                                           
      [19] "test_config_7_dummies_spec <- "                                                             
      [20] "  linear_reg(penalty = tune(), mixture = tune()) %>% "                                      
      [21] "  set_mode(\"regression\") %>% "                                                            
      [22] "  set_engine(\"glmnet\") "                                                                  
      [23] ""                                                                                           
      [24] "test_config_7_dummies_workflow <- "                                                         
      [25] "  workflow() %>% "                                                                          
      [26] "  add_recipe(test_config_7_dummies_recipe) %>% "                                            
      [27] "  add_model(test_config_7_dummies_spec) "                                                   
      [28] ""                                                                                           
      [29] "test_config_7_dummies_grid <- tidyr::crossing(penalty = 10^seq(-6, -1, length.out = 20), "  
      [30] "    mixture = c(0.05, 0.2, 0.4, 0.6, 0.8, 1)) "                                             
      [31] ""                                                                                           
      [32] "test_config_7_dummies_tune <- "                                                             
      [33] "  tune_grid(test_config_7_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [34] "    grid = test_config_7_dummies_grid) "                                                    
...
---
    ...
    Output
      ...
      [17] "  step_normalize(all_numeric_predictors()) "                                                   
      [18] ""                                                                                              
      [19] "test_config_7_no_dummies_spec <- "                                                             
      [20] "  multinom_reg(penalty = tune(), mixture = tune()) %>% "                                       
      [21] "  set_mode(\"classification\") %>% "                                                           
      [22] "  set_engine(\"glmnet\") "                                                                     
      [23] ""                                                                                              
      [24] "test_config_7_no_dummies_workflow <- "                                                         
      [25] "  workflow() %>% "                                                                             
      [26] "  add_recipe(test_config_7_no_dummies_recipe) %>% "                                            
      [27] "  add_model(test_config_7_no_dummies_spec) "                                                   
      [28] ""                                                                                              
      [29] "test_config_7_no_dummies_grid <- tidyr::crossing(penalty = 10^seq(-6, -1, length.out = 20), "  
      [30] "    mixture = c(0.05, 0.2, 0.4, 0.6, 0.8, 1)) "                                                
      [31] ""                                                                                              
      [32] "test_config_7_no_dummies_tune <- "                                                             
      [33] "  tune_grid(test_config_7_no_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [34] "    grid = test_config_7_no_dummies_grid) "                                                    
...
---
    ...
    Output
      ...
      [21] ""                                                                                           
      [22] "test_config_8_dummies_workflow <- "                                                         
      [23] "  workflow() %>% "                                                                          
      [24] "  add_recipe(test_config_8_dummies_recipe) %>% "                                            
      [25] "  add_model(test_config_8_dummies_spec) "                                                   
      [26] ""                                                                                           
      [27] "set.seed(27246)"                                                                            
      [28] "test_config_8_dummies_tune <-"                                                              
      [29] "  tune_grid(test_config_8_dummies_workflow, resamples = stop(\"add your rsample object\"), "
...
---
    ...
    Output
      ...
      [14] "  step_zv(all_predictors()) "                                                                  
      [15] ""                                                                                              
      [16] "test_config_8_no_dummies_spec <- "                                                             
      [17] "  boost_tree(trees = tune(), min_n = tune(), tree_depth = tune(), learn_rate = tune(), "       
      [18] "    loss_reduction = tune(), sample_size = tune()) %>% "                                       
      [19] "  set_mode(\"classification\") %>% "                                                           
      [20] "  set_engine(\"xgboost\") "                                                                    
      [21] ""                                                                                              
      [22] "test_config_8_no_dummies_workflow <- "                                                         
      [23] "  workflow() %>% "                                                                             
      [24] "  add_recipe(test_config_8_no_dummies_recipe) %>% "                                            
      [25] "  add_model(test_config_8_no_dummies_spec) "                                                   
      [26] ""                                                                                              
      [27] "set.seed(27246)"                                                                               
      [28] "test_config_8_no_dummies_tune <-"                                                              
      [29] "  tune_grid(test_config_8_no_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [30] "    grid = stop(\"add number of candidate points\"))"                                          
...
---
    ...
    Output
       ...
       [5] "  step_string2factor(one_of(\"island\")) "                                                  
       [6] ""                                                                                           
       [7] "test_config_9_dummies_spec <- "                                                             
       [8] "  rand_forest(mtry = tune(), min_n = tune(), trees = 1000) %>% "                            
       [9] "  set_mode(\"regression\") %>% "                                                            
      [10] "  set_engine(\"ranger\") "                                                                  
      [11] ""                                                                                           
      [12] "test_config_9_dummies_workflow <- "                                                         
      [13] "  workflow() %>% "                                                                          
      [14] "  add_recipe(test_config_9_dummies_recipe) %>% "                                            
      [15] "  add_model(test_config_9_dummies_spec) "                                                   
      [16] ""                                                                                           
      [17] "set.seed(27246)"                                                                            
      [18] "test_config_9_dummies_tune <-"                                                              
      [19] "  tune_grid(test_config_9_dummies_workflow, resamples = stop(\"add your rsample object\"), "
...
---
    ...
    Output
      ...
      [16] ""                                                                                              
      [17] "set.seed(27246)"                                                                               
      [18] "test_config_9_no_dummies_tune <-"                                                              
      [19] "  tune_grid(test_config_9_no_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [20] "    grid = stop(\"add number of candidate points\"))"                                          
...
---
    ...
    Output
      ...
      [28] ""                                                                                            
      [29] "set.seed(27246)"                                                                             
      [30] "test_config_10_dummies_tune <-"                                                              
      [31] "  tune_grid(test_config_10_dummies_workflow, resamples = stop(\"add your rsample object\"), "
...
---
    ...
    Output
      ...
      [28] ""                                                                                               
      [29] "set.seed(27246)"                                                                                
      [30] "test_config_10_no_dummies_tune <-"                                                              
      [31] "  tune_grid(test_config_10_no_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [32] "    grid = stop(\"add number of candidate points\"))"                                           
...
---
    ...
    Output
      ...
      [23] ""                                                                                            
      [24] "test_config_11_dummies_grid <- tidyr::crossing(num_terms = 2 * (1:6), prod_degree = 1:2) "   
      [25] ""                                                                                            
      [26] "test_config_11_dummies_tune <- "                                                             
      [27] "  tune_grid(test_config_11_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [28] "    grid = test_config_11_dummies_grid) "                                                    
...
---
    ...
    Output
      ...
      [23] ""                                                                                               
      [24] "test_config_11_no_dummies_grid <- tidyr::crossing(num_terms = 2 * (1:6), prod_degree = 1:2) "   
      [25] ""                                                                                               
      [26] "test_config_11_no_dummies_tune <- "                                                             
      [27] "  tune_grid(test_config_11_no_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [28] "    grid = test_config_11_no_dummies_grid) "                                                    
...
---
    ...
    Output
       [1] "library(rules)"                                                                              
       [2] ""                                                                                            
       [3] "test_config_12_dummies_recipe <- "                                                           
       [4] "  recipe(formula = body_mass_g ~ ., data = penguins, clipboard = TRUE) %>% "                 
       [5] "  ## For modeling, it is preferred to encode qualitative data as factors "                   
       [6] "  ## (instead of character). "                                                               
       [7] "  step_string2factor(one_of(\"island\")) %>% "                                               
       [8] "  step_zv(all_predictors()) "                                                                
       [9] ""                                                                                            
      [10] "test_config_12_dummies_spec <- "                                                             
      [11] "  cubist_rules(committees = tune(), neighbors = tune()) %>% "                                
      [12] "  set_engine(\"Cubist\") "                                                                   
      [13] ""                                                                                            
      [14] "test_config_12_dummies_workflow <- "                                                         
      [15] "  workflow() %>% "                                                                           
      [16] "  add_recipe(test_config_12_dummies_recipe) %>% "                                            
      [17] "  add_model(test_config_12_dummies_spec) "                                                   
      [18] ""                                                                                            
      [19] "test_config_12_dummies_grid <- tidyr::crossing(committees = c(1:9, (1:5) * "                 
      [20] "    10), neighbors = c(0, 3, 6, 9)) "                                                        
      [21] ""                                                                                            
      [22] "test_config_12_dummies_tune <- "                                                             
      [23] "  tune_grid(test_config_12_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [24] "    grid = test_config_12_dummies_grid) "                                                    
...
---
    ...
    Output
       ...
       [8] ""                                                                           
       [9] "test_config_13_dummies_spec <- "                                            
      [10] "  linear_reg() %>% "                                                        
      [11] "  set_mode(\"regression\") %>% "                                            
      [12] "  set_engine(\"glmnet\") "                                                  
      [13] ""                                                                           
      [14] "test_config_13_dummies_workflow <- "                                        
      [15] "  workflow() %>% "                                                          
      [16] "  add_recipe(test_config_13_dummies_recipe) %>% "                           
      [17] "  add_model(test_config_13_dummies_spec) "                                  
...
---
    ...
    Output
       ...
       [7] "  step_normalize(all_numeric_predictors()) "                            
       [8] ""                                                                       
       [9] "test_config_13_no_dummies_spec <- "                                     
      [10] "  multinom_reg() %>% "                                                  
      [11] "  set_mode(\"classification\") %>% "                                    
      [12] "  set_engine(\"glmnet\") "                                              
      [13] ""                                                                       
      [14] "test_config_13_no_dummies_workflow <- "                                 
      [15] "  workflow() %>% "                                                      
      [16] "  add_recipe(test_config_13_no_dummies_recipe) %>% "                    
      [17] "  add_model(test_config_13_no_dummies_spec) "                           
...
---
    ...
    Output
       ...
       [6] "  step_zv(all_predictors()) "                                               
       [7] ""                                                                           
       [8] "test_config_14_dummies_spec <- "                                            
       [9] "  boost_tree() %>% "                                                        
      [10] "  set_mode(\"regression\") %>% "                                            
      [11] "  set_engine(\"xgboost\") "                                                 
      [12] ""                                                                           
      [13] "test_config_14_dummies_workflow <- "                                        
      [14] "  workflow() %>% "                                                          
      [15] "  add_recipe(test_config_14_dummies_recipe) %>% "                           
      [16] "  add_model(test_config_14_dummies_spec) "                                  
...
---
    ...
    Output
       ...
       [6] "  step_zv(all_predictors()) "                                           
       [7] ""                                                                       
       [8] "test_config_14_no_dummies_spec <- "                                     
       [9] "  boost_tree() %>% "                                                    
      [10] "  set_mode(\"classification\") %>% "                                    
      [11] "  set_engine(\"xgboost\") "                                             
      [12] ""                                                                       
      [13] "test_config_14_no_dummies_workflow <- "                                 
      [14] "  workflow() %>% "                                                      
      [15] "  add_recipe(test_config_14_no_dummies_recipe) %>% "                    
      [16] "  add_model(test_config_14_no_dummies_spec) "                           
...
---
    ...
    Output
       ...
       [7] "  step_normalize(all_numeric_predictors()) "                            
       [8] ""                                                                       
       [9] "test_config_16_no_dummies_spec <- "                                     
      [10] "  nearest_neighbor() %>% "                                              
      [11] "  set_mode(\"classification\") %>% "                                    
      [12] "  set_engine(\"kknn\") "                                                
      [13] ""                                                                       
...
---
    ...
    Output
       ...
       [6] "  step_zv(all_predictors()) "                                               
       [7] ""                                                                           
       [8] "test_config_17_dummies_spec <- "                                            
       [9] "  mars() %>% "                                                              
      [10] "  set_mode(\"regression\") %>% "                                            
      [11] "  set_engine(\"earth\") "                                                   
      [12] ""                                                                           
      [13] "test_config_17_dummies_workflow <- "                                        
      [14] "  workflow() %>% "                                                          
      [15] "  add_recipe(test_config_17_dummies_recipe) %>% "                           
      [16] "  add_model(test_config_17_dummies_spec) "                                  
...
---
    ...
    Output
       ...
       [6] "  step_zv(all_predictors()) "                                           
       [7] ""                                                                       
       [8] "test_config_17_no_dummies_spec <- "                                     
       [9] "  mars() %>% "                                                          
      [10] "  set_mode(\"classification\") %>% "                                    
      [11] "  set_engine(\"earth\") "                                               
      [12] ""                                                                       
      [13] "test_config_17_no_dummies_workflow <- "                                 
      [14] "  workflow() %>% "                                                      
      [15] "  add_recipe(test_config_17_no_dummies_recipe) %>% "                    
      [16] "  add_model(test_config_17_no_dummies_spec) "                           
...
---
    ...
    Output
       [1] "library(rules)"                                                             
       [2] ""                                                                           
       [3] "test_config_18_dummies_recipe <- "                                          
       [4] "  recipe(formula = body_mass_g ~ ., data = penguins, clipboard = TRUE) %>% "
       [5] "  step_string2factor(one_of(\"island\")) %>% "                              
       [6] "  step_zv(all_predictors()) "                                               
       [7] ""                                                                           
       [8] "test_config_18_dummies_spec <- "                                            
       [9] "  cubist_rules() %>% "                                                      
      [10] "  set_engine(\"Cubist\") "                                                  
      [11] ""                                                                           
      [12] "test_config_18_dummies_workflow <- "                                        
      [13] "  workflow() %>% "                                                          
...
---
    ...
    Output
      ...
      [18] ""                                                                                            
      [19] "test_config_19_dummies_grid <- tidyr::crossing(penalty = 10^seq(-6, -1, length.out = 20), "  
...
---
    ...
    Output
      ...
      [18] ""                                                                                               
      [19] "test_config_19_no_dummies_grid <- tidyr::crossing(penalty = 10^seq(-6, -1, "                    
      [20] "    length.out = 20), mixture = c(0.05, 0.2, 0.4, 0.6, 0.8, 1)) "                               
      [21] ""                                                                                               
      [22] "test_config_19_no_dummies_tune <- "                                                             
      [23] "  tune_grid(test_config_19_no_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [24] "    grid = test_config_19_no_dummies_grid) "                                                    
...
---
    ...
    Output
      ...
      [13] ""                                                                                            
      [14] "test_config_20_dummies_workflow <- "                                                         
      [15] "  workflow() %>% "                                                                           
      [16] "  add_recipe(test_config_20_dummies_recipe) %>% "                                            
      [17] "  add_model(test_config_20_dummies_spec) "                                                   
      [18] ""                                                                                            
      [19] "set.seed(27246)"                                                                             
      [20] "test_config_20_dummies_tune <-"                                                              
      [21] "  tune_grid(test_config_20_dummies_workflow, resamples = stop(\"add your rsample object\"), "
...
---
    ...
    Output
      ...
      [12] "  set_engine(\"xgboost\") "                                                                     
      [13] ""                                                                                               
      [14] "test_config_20_no_dummies_workflow <- "                                                         
      [15] "  workflow() %>% "                                                                              
      [16] "  add_recipe(test_config_20_no_dummies_recipe) %>% "                                            
      [17] "  add_model(test_config_20_no_dummies_spec) "                                                   
      [18] ""                                                                                               
      [19] "set.seed(27246)"                                                                                
      [20] "test_config_20_no_dummies_tune <-"                                                              
      [21] "  tune_grid(test_config_20_no_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [22] "    grid = stop(\"add number of candidate points\"))"                                           
...
---
    ...
    Output
      ...
      [14] ""                                                                                            
      [15] "set.seed(27246)"                                                                             
      [16] "test_config_21_dummies_tune <-"                                                              
      [17] "  tune_grid(test_config_21_dummies_workflow, resamples = stop(\"add your rsample object\"), "
...
---
    ...
    Output
      ...
      [14] ""                                                                                               
      [15] "set.seed(27246)"                                                                                
      [16] "test_config_21_no_dummies_tune <-"                                                              
      [17] "  tune_grid(test_config_21_no_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [18] "    grid = stop(\"add number of candidate points\"))"                                           
...
---
    ...
    Output
      ...
      [18] ""                                                                                            
      [19] "set.seed(27246)"                                                                             
      [20] "test_config_22_dummies_tune <-"                                                              
      [21] "  tune_grid(test_config_22_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [22] "    grid = stop(\"add number of candidate points\"))"                                        
...
---
    ...
    Output
      ...
      [18] ""                                                                                               
      [19] "set.seed(27246)"                                                                                
      [20] "test_config_22_no_dummies_tune <-"                                                              
      [21] "  tune_grid(test_config_22_no_dummies_workflow, resamples = stop(\"add your rsample object\"), "
      [22] "    grid = stop(\"add number of candidate points\"))"                                           
...
---
    ...
    Output
      ...
      [16] ""                                                                                            
      [17] "test_config_24_dummies_grid <- tidyr::crossing(committees = c(1:9, (1:5) * "                 
